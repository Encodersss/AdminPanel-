...
$timeout = 10*60;
	if (isset($_SESSION['logged'])){
	  ...
	  if ($_SESSION['logged'] + $timeout< time()) {
		...
		if(isset($_POST['btn_save_updates'])){
			...
			$id                 =   $_POST['edit_id'];//istediğimiz bir id nosu vererek de güncelleme işlemi yapılır. diğer sayfadan gönderilmeden...
...
<div class="col-md-12 footer_duzen">
  <a href="#"><strong> ©2018 Bütün Hakları Saklıdır.</strong></a>
</div>
</footer>
